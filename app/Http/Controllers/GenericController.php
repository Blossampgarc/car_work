                            ...
                            <div class="form-group start-date">
                                ...
                                <div class="d-flex">
                                    <select name="brand_id" id="brand_id" class="form-control profession" required value="">
                                        ...
                                        //     }
                                        // }
                                            $body.='<option value="1">BREMBO</option>';
                                            $body.='<option value="9">ACCEL</option>';
                                            $body.='<option value="10">Diode Dynamics</option>';
                                            $body.='<option value="11">Goodyear Wiper Blades</option>';
                            $body.='</select>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 col-sm-6 col-12 im" id="rank-label">
                            <div class="form-group start-date">

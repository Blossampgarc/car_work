                    ...
                    <form id="myform" method="POST">
                        <div class="brand-blk">
                            ...
                            <div class="inr-products">
                                ...
                                @if($key < 10) <label class="chckkbox">
                                    {{$com->name}}
                                    ...
                                    <span id="more">
                                        ...
                                        <label class="chckkbox">
                                            {{$com->name}}
                                            <input type="checkbox" class="FormClass" name="company[]"
                                                value="{{$com->id}}" />
                                            <span class="checkmark"></span>
                                        </label>
                                        @endif
                            ...
                            <div class="view-more">
                                <a href="javascript:void(0)" onclick="myFunction()" id="myBtn"><i
                                        class="fa fa-plus-circle" aria-hidden="true"></i> View More</a>
                              ...
                              <div class="rangeslider-inr">
                                    ...
                                    <div class="brand-blk">
                                        ...
                                        <div class="inr-products">
                                            ...
                                            <label class="chckkbox">
                                                {{$vals->name}}
                                                <input type="checkbox" name="brand" value="{{$vals->id}}"
                                                    class="brand-check-input" />
                                                <span class="checkmark"></span>
                                            </label>
                                            @endforeach
                                        ...
                                        <div class="view-more">
                                            ...
                                            <button type="button" onclick="myFunction()" id="myBtn"><i
                                                    class="fa fa-plus-circle" aria-hidden="true"></i>View More</button>
                                        </div>
                                        --}}
                                        <div class="clear">
    ...
    <div class="col-md-9">
        <div class="showitem-main">
            ...
            <div class="text-center">
                <ul class="pagination">
                    {!! $cat_products->links("pagination::bootstrap-4") !!}
                </ul>
            </div>
